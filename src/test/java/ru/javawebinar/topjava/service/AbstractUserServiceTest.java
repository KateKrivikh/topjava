...
public abstract class AbstractUserServiceTest extends AbstractServiceTest {
    ...
    void enable() throws Exception {
        boolean enabledExpected = false;
        User userExpected = service.get(USER_ID);
        userExpected.setEnabled(enabledExpected);

        service.enable(USER_ID, enabledExpected);

        USER_MATCHER.assertMatch(service.get(USER_ID), userExpected);
    }
