...
public abstract class AbstractMealController {
     ...
     * </ol>
     */
    public List<MealTo> getAllBetween(@Nullable LocalDate startDate, @Nullable LocalDate endDate, @Nullable LocalTime startTime, @Nullable LocalTime endTime) {
        int userId = SecurityUtil.authUserId();
    ...
    protected boolean isNew(HttpServletRequest request) {
